  ...
  def link_css(current_page: false)
    class_names(
      "w-full [&>a]:flex [&>a]:items-center [&>a]:px-3 [&>a]:py-1 [&>a]:w-full [&>a]:text-sm [&>a]:font-semibold [&>a]:rounded-md [&>a]:max-md:py-2",
      {
        ...
        "[&>a]:text-sky-500 [&>a]:bg-sky-50 [&>a]:hover:text-sky-500 [&>a]:hover:bg-sky-50": current_page && @theme.light?,
        "[&>a]:text-sky-300 [&>a]:bg-sky-900/60 [&>a]:hover:text-sky-300 [&>a]:hover:bg-sky-900/60": current_page && @theme.dark?
      }
    )
  end
end
